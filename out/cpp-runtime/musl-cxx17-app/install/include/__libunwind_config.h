...
#define _LIBUNWIND_HIGHEST_DWARF_REGISTER_LINX      23
...
# elif defined(__LINX__) || defined(__linx__)
#  define _LIBUNWIND_TARGET_LINX 1
#  define _LIBUNWIND_CONTEXT_SIZE 24
#  define _LIBUNWIND_CURSOR_SIZE 36
#  define _LIBUNWIND_HIGHEST_DWARF_REGISTER                                     \
   _LIBUNWIND_HIGHEST_DWARF_REGISTER_LINX
