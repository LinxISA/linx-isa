...
if(CMAKE_INSTALL_COMPONENT STREQUAL "cxx-modules" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/libc++/v1" TYPE FILE PERMISSIONS OWNER_READ OWNER_WRITE GROUP_READ WORLD_READ FILES
    "/Users/zhoubot/llvm-project/build-linxisa-clang/modules/c++/v1/std.cppm"
    "/Users/zhoubot/llvm-project/build-linxisa-clang/modules/c++/v1/std.compat.cppm"
    )
endif()

if(CMAKE_INSTALL_COMPONENT STREQUAL "cxx-modules" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE FILE PERMISSIONS OWNER_READ OWNER_WRITE GROUP_READ WORLD_READ FILES "/Users/zhoubot/linx-isa/out/cpp-runtime/musl-cxx17-full/build/phase-b/./lib/libc++.modules.json")
endif()

string(REPLACE ";" "\n" CMAKE_INSTALL_MANIFEST_CONTENT
       "${CMAKE_INSTALL_MANIFEST_FILES}")
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/Users/zhoubot/linx-isa/out/cpp-runtime/musl-cxx17-full/build/phase-b/libcxx/modules/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
