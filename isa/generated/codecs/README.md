...
- Source of truth: `isa/v0.4/linxisa-v0.4.json`
- Generators:
...
```bash
python3 tools/isa/gen_qemu_codec.py --spec isa/v0.4/linxisa-v0.4.json --out-dir isa/generated/codecs
python3 tools/isa/gen_c_codec.py --spec isa/v0.4/linxisa-v0.4.json --out-dir isa/generated/codecs
