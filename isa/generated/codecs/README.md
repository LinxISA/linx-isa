...
- Source of truth: `isa/v0.58/linxisa-v0.58.json`
- Generators:
...
```bash
python3 tools/isa/gen_qemu_codec.py --spec isa/v0.58/linxisa-v0.58.json --out-dir isa/generated/codecs
python3 tools/isa/gen_c_codec.py --spec isa/v0.58/linxisa-v0.58.json --out-dir isa/generated/codecs
python3 tools/isa/validate_spec.py --spec isa/v0.58/linxisa-v0.58.json
```
