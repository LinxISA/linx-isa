...
class V0581FixtureRoutingTest(unittest.TestCase):
    def test_current_lane_routes_only_v0581_fixture(self) -> None:
        self.assertTrue((CURRENT_ASM / "41_v0581_isa_forms.s").is_file())
        self.assertFalse((CURRENT_ASM / "41_v057_isa_forms.s").exists())
        self.assertTrue((ARCHIVED_ASM / "41_v057_isa_forms.s").is_file())

        runner = RUNNER.read_text()
        self.assertIn("41_v0581_isa_forms)", runner)
