...
- **主手册层级**：当前公开手册结构，面向 v0.57
- **机器生成附录**：v0.57 生成型参考页

前者承担主要公开叙事结构，后者承担精确的助记符、分组、编码与逐条指令检索。

**ISA 版本：** v0.57.0 · **767 个指令形式** · **67 个分组** · **4 种编码格式**

v0.57 建立在 v0.57 基线之上，只记录增量：标量 CAS/DMA 编码变更、
TMA 命名块头扩展、PTO TileOp 扩展以及 CUBE 命名块头约束。历史 v0.57 页面仅作为
归档/兼容证据保留，不再作为活动拼写来源。
