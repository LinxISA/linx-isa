...
```asm
TGEMV.BIAS <LB0:M, LB1:N, LB2:K, DataType> SrcTile0<.reuse>, SrcTile1<.reuse>, SrcTile2<.reuse>
```
...
- [BSTART.TGEMV.BIAS](../../blockIntro/cube_block/header.md) `DataType`
...
```asm
TGEMV.BIAS <LB0:1, LB1:32, LB2:32, FP16>, T#1, U#1, M#1
```
