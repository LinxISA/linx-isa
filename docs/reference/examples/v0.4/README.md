# LinxISA Assembly Sample Pack (v0.4)

Canonical public assembly examples for LinxISA v0.4.
...
Source: `docs/reference/examples/v0.4/curated/linxisa-v0.4-normalized.asm`
