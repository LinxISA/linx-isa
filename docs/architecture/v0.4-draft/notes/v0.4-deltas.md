...
- In-kernel scalar + vector instructions are treated as a **unified 64-bit encoding space** with shared operand naming; `l.*` vs `v.*` distinguishes scalar-lane vs vector-lane execution.
