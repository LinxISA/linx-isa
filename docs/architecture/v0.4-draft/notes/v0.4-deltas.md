...
- Reuse vec-engine scalar-lane predicate register **`p`** as the **EXEC mask**, and make `p` readable/writable by scalar-lane instructions in kernel bodies (normal src/dst operand role).
