...
This section provides per-mnemonic descriptions. The tables above remain the authoritative listing of encodable forms and decode layouts in the v0.58.1 catalog. Descriptions and pseudocode here are derived from mnemonic naming conventions plus catalog assembly templates/notes and are intended to be *informative*.
...
Encoding::
+
.`b_eq_32_f0f909e9f755` — `b.eq SrcL, SrcR, label`
image::encodings/enc_b_eq.svg[B.EQ encoding form b_eq_32_f0f909e9f755,align="center"]
...
Encoding::
+
.`b_ge_32_4d00af558ba0` — `b.ge SrcL, SrcR, label`
image::encodings/enc_b_ge.svg[B.GE encoding form b_ge_32_4d00af558ba0,align="center"]
...
Encoding::
+
.`b_geu_32_7832bac8f1a4` — `b.geu SrcL, SrcR, label`
image::encodings/enc_b_geu.svg[B.GEU encoding form b_geu_32_7832bac8f1a4,align="center"]
...
Encoding::
+
.`b_lt_32_59c035b9c132` — `b.lt SrcL, SrcR, label`
image::encodings/enc_b_lt.svg[B.LT encoding form b_lt_32_59c035b9c132,align="center"]
...
Encoding::
+
.`b_ltu_32_fe13236f720b` — `b.ltu SrcL, SrcR, label`
image::encodings/enc_b_ltu.svg[B.LTU encoding form b_ltu_32_fe13236f720b,align="center"]
...
Encoding::
+
.`b_ne_32_af79aa13d05a` — `b.ne SrcL, SrcR, label`
image::encodings/enc_b_ne.svg[B.NE encoding form b_ne_32_af79aa13d05a,align="center"]
...
Encoding::
+
.`b_nz_32_890ac2de1897` — `b.nz label`
image::encodings/enc_b_nz.svg[B.NZ encoding form b_nz_32_890ac2de1897,align="center"]
...
Encoding::
+
.`b_z_32_caa0ef1ffc2e` — `b.z label`
image::encodings/enc_b_z.svg[B.Z encoding form b_z_32_caa0ef1ffc2e,align="center"]
...
Encoding::
+
.`b_fpatr_32_cba93d710148` — `B.FPATR PreQuantMode, ReluMode, GroupNCode, RowMaxEn, GroupMaxEn, RowMaxInit, MaxAbsEn`
image::encodings/enc_b_fpatr.svg[B.FPATR encoding form b_fpatr_32_cba93d710148,align="center"]
...
Encoding::
+
.`hl_lb_po_48_6681088ab2a9` — `hl.lb.po [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lbu_po_48_7269ae6c8b57` — `hl.lbu.po [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_ld_po_48_bf5a47212c1e` — `hl.ld.po [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lh_po_48_94154c7cdaba` — `hl.lh.po [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lhu_po_48_70fcb01a2cd1` — `hl.lhu.po [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lw_po_48_e8f3606964a3` — `hl.lw.po [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lwu_po_48_ec309139d376` — `hl.lwu.po [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lb_pr_48_7dd145c8dca5` — `hl.lb.pr [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lbu_pr_48_38f53bbd7a7d` — `hl.lbu.pr [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_ld_pr_48_b3cce95b31c8` — `hl.ld.pr [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lh_pr_48_d39cc9e74fc5` — `hl.lh.pr [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lhu_pr_48_2b52029d8c1e` — `hl.lhu.pr [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lw_pr_48_18db10ea88bf` — `hl.lw.pr [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lwu_pr_48_319ed7e2c7d1` — `hl.lwu.pr [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lbp_48_2fcf575fd0c8` — `hl.lbp [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lbup_48_c9bf719605ca` — `hl.lbup [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_ldp_48_bacfe47cfd0b` — `hl.ldp [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lhp_48_1a5646453ffe` — `hl.lhp [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lhup_48_0ba242a670ec` — `hl.lhup [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lwp_48_7a46de902d85` — `hl.lwp [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_lwup_48_9af645913747` — `hl.lwup [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->Dst0, Dst1`
...
Encoding::
+
.`hl_prf_48_6a2f3688490f` — `hl.prf{.l1,.l2,.l3} [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>]`
...
Encoding::
+
.`hl_prf_a_48_1dc197c8b5a5` — `hl.prf.a{.l1,.l2,.l3} [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sb_po_48_bb1ccb3da24b` — `hl.sb.po SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sd_po_48_f335328a7f87` — `hl.sd.po SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<3], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sd_upo_48_7d91573c6555` — `hl.sd.upo SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sh_po_48_2b20a782f566` — `hl.sh.po SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<1], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sh_upo_48_d28769e5b16f` — `hl.sh.upo SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sw_po_48_3183f373cc63` — `hl.sw.po SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<2], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sw_upo_48_bab8d2d69b0b` — `hl.sw.upo SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sb_pr_48_6355032ffe23` — `hl.sb.pr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sd_pr_48_a9ff27c38e8d` — `hl.sd.pr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<3], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sd_upr_48_9dcf6a32e5df` — `hl.sd.upr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sh_pr_48_ec007e4fe531` — `hl.sh.pr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<1], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sh_upr_48_d53d5eeaff29` — `hl.sh.upr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sw_pr_48_f2ebdd2d507e` — `hl.sw.pr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<2], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sw_upr_48_0710e763bdf1` — `hl.sw.upr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}`
...
Encoding::
+
.`hl_sbp_48_4e0c7cb0c724` — `hl.sbp SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}>]`
...
Encoding::
+
.`hl_sdp_48_355cef372d62` — `hl.sdp SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}><<3]`
...
Encoding::
+
.`hl_sdp_u_48_30e8e0d29477` — `hl.sdp.u SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}>]`
...
Encoding::
+
.`hl_shp_48_c360aaff00b3` — `hl.shp SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}><<1]`
...
Encoding::
+
.`hl_shp_u_48_f36739d9d0e0` — `hl.shp.u SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}>]`
...
Encoding::
+
.`hl_swp_48_86359b86a0ae` — `hl.swp SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}><<2]`
...
Encoding::
+
.`hl_swp_u_48_31bb1fa06039` — `hl.swp.u SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}>]`
...
Encoding::
+
.`lb_32_69fa62bab890` — `lb [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}`
...
Encoding::
+
.`lbu_32_3dba99c3867b` — `lbu [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}`
...
Encoding::
+
.`ld_32_6ccb1c483bc5` — `ld [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}`
...
Encoding::
+
.`lh_32_ba0f2afd9b3f` — `lh [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}`
...
Encoding::
+
.`lhu_32_050c45d23cc9` — `lhu [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}`
...
Encoding::
+
.`lw_32_3ab9351b5a00` — `lw [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}`
...
Encoding::
+
.`lwu_32_59dfc83ee4f4` — `lwu [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}`
...
Encoding::
+
.`prf_32_a91e5e18a496` — `prf [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>]`
...
Encoding::
+
.`sb_32_f0f61f5c7063` — `sb SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>]`
...
Encoding::
+
.`sd_32_324dd0ff5d29` — `sd SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<3]`
...
Encoding::
+
.`sd_u_32_854cc53e5b65` — `sd.u SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>]`
...
Encoding::
+
.`sh_32_80b2371159a4` — `sh SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<1]`
...
Encoding::
+
.`sh_u_32_bf6553f1739e` — `sh.u SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>]`
...
Encoding::
+
.`sw_32_4fdd666796e5` — `sw SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<2]`
...
Encoding::
+
.`sw_u_32_9f812ca5bf87` — `sw.u SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>]`
