...
Encoding::
+
.`b_ior_32_df50a269be7c` — `B.IOR [RegSrc0, RegSrc1, RegSrc2],[RegDst]`
...
.`bstart_tmov_32_68c4ed390b75` — `BSTART.TMOV DataType`
image::encodings/enc_bstart_tmov_32_68c4ed390b75.svg[BSTART.TMOV encoding form bstart_tmov_32_68c4ed390b75,align="center"]
...
Encoding::
+
.`bstart_tstore_32_6f6869479814` — `BSTART.TSTORE DataType`
image::encodings/enc_bstart_tstore_32_6f6869479814.svg[BSTART.TSTORE encoding form bstart_tstore_32_6f6869479814,align="center"]
...
[[insndesc-bundle-shared-operand-binding]]
==== Bundle Shared Operand Binding

[[insndesc-bundle-shared-operand-binding-c-b-ios]]
===== C.B.IOS
...
Encoding::
+
.`c_b_ios_16_5c9d7b427740` — `C.B.IOS S<SharedTID> \| C.B.IOS ->S<SharedTID>`
image::encodings/enc_c_b_ios.svg[C.B.IOS encoding form c_b_ios_16_5c9d7b427740,align="center"]
