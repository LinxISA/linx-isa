...
Encoding::
+
.`bstart_tma_32_f949c94c39c7` — `BSTART.TMA Function, DataType`
image::encodings/enc_bstart_tma.svg[BSTART.TMA encoding form bstart_tma_32_f949c94c39c7,align="center"]
...
Encoding::
+
.`bstart_call_32_9404418d1ae5` — `BSTART.CALL <br_label>`
...
Encoding::
+
.`hl_bstart_call_48_3c784c583c90` — `HL.BSTART.CALL <br_label>`
