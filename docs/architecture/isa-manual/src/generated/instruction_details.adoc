...
Assembly forms::
+
* `cls SrcL, Nminus1, M, ->{t, u, Rd}`

Encoding::
+
image::encodings/enc_cls.svg[CLS encoding diagram,align="center"]
...
[[insndesc-bit-manipulation-v-cls]]
===== V.CLS
