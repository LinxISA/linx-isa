...
This section provides per-mnemonic descriptions. The tables above remain the authoritative listing of encodable forms and decode layouts in the v0.58.6 catalog. Descriptions and pseudocode here are derived from mnemonic naming conventions plus catalog assembly templates/notes and are intended to be *informative*.
...
[[insndesc-bundle-split-bstart-mgather-add]]
===== BSTART.MGATHER.ADD
...
Encoding::
+
.`bstart_mgather_add_32_088f8627077f` — `BSTART.MGATHER.ADD DataType`
image::encodings/enc_bstart_mgather_add.svg[BSTART.MGATHER.ADD encoding form bstart_mgather_add_32_088f8627077f,align="center"]
...
[[insndesc-bundle-split-bstart-mgather-and]]
===== BSTART.MGATHER.AND
...
Encoding::
+
.`bstart_mgather_and_32_232d20899377` — `BSTART.MGATHER.AND DataType`
image::encodings/enc_bstart_mgather_and.svg[BSTART.MGATHER.AND encoding form bstart_mgather_and_32_232d20899377,align="center"]
...
[[insndesc-bundle-split-bstart-mgather-dec]]
===== BSTART.MGATHER.DEC
...
Encoding::
+
.`bstart_mgather_dec_32_a4404f381481` — `BSTART.MGATHER.DEC DataType`
image::encodings/enc_bstart_mgather_dec.svg[BSTART.MGATHER.DEC encoding form bstart_mgather_dec_32_a4404f381481,align="center"]
...
[[insndesc-bundle-split-bstart-mgather-exch]]
===== BSTART.MGATHER.EXCH
...
Encoding::
+
.`bstart_mgather_exch_32_c3ad9cf2ffd3` — `BSTART.MGATHER.EXCH DataType`
image::encodings/enc_bstart_mgather_exch.svg[BSTART.MGATHER.EXCH encoding form bstart_mgather_exch_32_c3ad9cf2ffd3,align="center"]
...
[[insndesc-bundle-split-bstart-mgather-inc]]
===== BSTART.MGATHER.INC
...
Encoding::
+
.`bstart_mgather_inc_32_da1952ec2a27` — `BSTART.MGATHER.INC DataType`
image::encodings/enc_bstart_mgather_inc.svg[BSTART.MGATHER.INC encoding form bstart_mgather_inc_32_da1952ec2a27,align="center"]
...
[[insndesc-bundle-split-bstart-mgather-max]]
===== BSTART.MGATHER.MAX
...
Encoding::
+
.`bstart_mgather_max_32_e8ab09c078b5` — `BSTART.MGATHER.MAX DataType`
image::encodings/enc_bstart_mgather_max.svg[BSTART.MGATHER.MAX encoding form bstart_mgather_max_32_e8ab09c078b5,align="center"]
...
[[insndesc-bundle-split-bstart-mgather-min]]
===== BSTART.MGATHER.MIN
...
Encoding::
+
.`bstart_mgather_min_32_aade0e4a1ded` — `BSTART.MGATHER.MIN DataType`
image::encodings/enc_bstart_mgather_min.svg[BSTART.MGATHER.MIN encoding form bstart_mgather_min_32_aade0e4a1ded,align="center"]
...
[[insndesc-bundle-split-bstart-mgather-or]]
===== BSTART.MGATHER.OR
...
Encoding::
+
.`bstart_mgather_or_32_0c2334253cc3` — `BSTART.MGATHER.OR DataType`
image::encodings/enc_bstart_mgather_or.svg[BSTART.MGATHER.OR encoding form bstart_mgather_or_32_0c2334253cc3,align="center"]
...
[[insndesc-bundle-split-bstart-mgather-xor]]
===== BSTART.MGATHER.XOR
...
Encoding::
+
.`bstart_mgather_xor_32_f8b9f1a43450` — `BSTART.MGATHER.XOR DataType`
image::encodings/enc_bstart_mgather_xor.svg[BSTART.MGATHER.XOR encoding form bstart_mgather_xor_32_f8b9f1a43450,align="center"]
...
[[insndesc-bundle-split-bstart-mscatter-add]]
===== BSTART.MSCATTER.ADD
...
Encoding::
+
.`bstart_mscatter_add_32_f0caf08d9183` — `BSTART.MSCATTER.ADD DataType`
image::encodings/enc_bstart_mscatter_add.svg[BSTART.MSCATTER.ADD encoding form bstart_mscatter_add_32_f0caf08d9183,align="center"]
...
[[insndesc-bundle-split-bstart-mscatter-and]]
===== BSTART.MSCATTER.AND
...
Encoding::
+
.`bstart_mscatter_and_32_035c8fd2a29c` — `BSTART.MSCATTER.AND DataType`
image::encodings/enc_bstart_mscatter_and.svg[BSTART.MSCATTER.AND encoding form bstart_mscatter_and_32_035c8fd2a29c,align="center"]
...
[[insndesc-bundle-split-bstart-mscatter-dec]]
===== BSTART.MSCATTER.DEC
...
Encoding::
+
.`bstart_mscatter_dec_32_d307499ccedc` — `BSTART.MSCATTER.DEC DataType`
image::encodings/enc_bstart_mscatter_dec.svg[BSTART.MSCATTER.DEC encoding form bstart_mscatter_dec_32_d307499ccedc,align="center"]
...
[[insndesc-bundle-split-bstart-mscatter-inc]]
===== BSTART.MSCATTER.INC
...
Encoding::
+
.`bstart_mscatter_inc_32_2c10d5f5e1af` — `BSTART.MSCATTER.INC DataType`
image::encodings/enc_bstart_mscatter_inc.svg[BSTART.MSCATTER.INC encoding form bstart_mscatter_inc_32_2c10d5f5e1af,align="center"]
...
[[insndesc-bundle-split-bstart-mscatter-max]]
===== BSTART.MSCATTER.MAX
...
Encoding::
+
.`bstart_mscatter_max_32_7d06140ba225` — `BSTART.MSCATTER.MAX DataType`
image::encodings/enc_bstart_mscatter_max.svg[BSTART.MSCATTER.MAX encoding form bstart_mscatter_max_32_7d06140ba225,align="center"]
...
[[insndesc-bundle-split-bstart-mscatter-min]]
===== BSTART.MSCATTER.MIN
...
Encoding::
+
.`bstart_mscatter_min_32_1a9b89a73ebc` — `BSTART.MSCATTER.MIN DataType`
image::encodings/enc_bstart_mscatter_min.svg[BSTART.MSCATTER.MIN encoding form bstart_mscatter_min_32_1a9b89a73ebc,align="center"]
...
[[insndesc-bundle-split-bstart-mscatter-or]]
===== BSTART.MSCATTER.OR
...
Encoding::
+
.`bstart_mscatter_or_32_344e52424e47` — `BSTART.MSCATTER.OR DataType`
image::encodings/enc_bstart_mscatter_or.svg[BSTART.MSCATTER.OR encoding form bstart_mscatter_or_32_344e52424e47,align="center"]
...
[[insndesc-bundle-split-bstart-mscatter-popc]]
...
Encoding::
+
.`bstart_mscatter_popc_32_97e1aec263ac` — `BSTART.MSCATTER.POPC DataType`
image::encodings/enc_bstart_mscatter_popc.svg[BSTART.MSCATTER.POPC encoding form bstart_mscatter_popc_32_97e1aec263ac,align="center"]
...
[[insndesc-bundle-split-bstart-mscatter-xor]]
===== BSTART.MSCATTER.XOR
...
Encoding::
+
.`bstart_mscatter_xor_32_fa03881618df` — `BSTART.MSCATTER.XOR DataType`
image::encodings/enc_bstart_mscatter_xor.svg[BSTART.MSCATTER.XOR encoding form bstart_mscatter_xor_32_fa03881618df,align="center"]
...
[[insndesc-bundle-split-bstart-timg2col]]
===== BSTART.TIMG2COL
...
Encoding::
+
.`bstart_timg2col_32_557b5cf18709` — `BSTART.TIMG2COL DataType`
image::encodings/enc_bstart_timg2col.svg[BSTART.TIMG2COL encoding form bstart_timg2col_32_557b5cf18709,align="center"]
