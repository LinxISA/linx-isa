...
This table lists unique mnemonics in the v0.57.0 catalog. Each mnemonic may have multiple encodable forms (different lengths, operand layouts, or suffix variants).
...
|`BSTART.MGATHER` |Block Split |32 |1
|`BSTART.MGATHER.CAS` |Block Split |32 |1
|`BSTART.MGATHER.MASK` |Block Split |32 |1
|`BSTART.MPAR` |Block Split |32 |1
|`BSTART.MSCATTER` |Block Split |32 |1
|`BSTART.MSCATTER.MASK` |Block Split |32 |1
|`BSTART.MSEQ` |Block Split |32 |1
|`BSTART.STD` |Block Split |32 |7
|`BSTART.SYS` |Block Split |32 |1
|`BSTART.TEPL` |Block Split |32 |1
|`BSTART.TGEMV` |Block Split |32 |1
|`BSTART.TGEMV.ACC` |Block Split |32 |1
|`BSTART.TGEMV.BIAS` |Block Split |32 |1
|`BSTART.TGEMVMX` |Block Split |32 |1
|`BSTART.TGEMVMX.ACC` |Block Split |32 |1
|`BSTART.TGEMVMX.BIAS` |Block Split |32 |1
|`BSTART.TLOAD` |Block Split |32 |1
|`BSTART.TMATMUL` |Block Split |32 |1
|`BSTART.TMATMUL.ACC` |Block Split |32 |1
|`BSTART.TMATMUL.BIAS` |Block Split |32 |1
|`BSTART.TMATMULMX` |Block Split |32 |1
|`BSTART.TMATMULMX.ACC` |Block Split |32 |1
|`BSTART.TMATMULMX.BIAS` |Block Split |32 |1
|`BSTART.TMOV` |Block Split |32 |1
|`BSTART.TPREFETCH` |Block Split |32 |1
