...
This table lists unique mnemonics in the v0.58.5 catalog. Each mnemonic may have multiple encodable forms (different lengths, operand layouts, or suffix variants).
