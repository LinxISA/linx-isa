...
This table lists unique mnemonics in the v0.58.0 catalog. Each mnemonic may have multiple encodable forms (different lengths, operand layouts, or suffix variants).
...
|`C.B.IOS` |Bundle Shared Operand Binding |16 |1
...
|`CASB` |Atomic Operation |32 |1
|`CASD` |Atomic Operation |32 |1
|`CASH` |Atomic Operation |32 |1
|`CASW` |Atomic Operation |32 |1
