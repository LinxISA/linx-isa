...
*Description:* HL.SDI.PR snapshots its scalar sources, forms its encoded address, and stores one aligned little-endian 8-byte value.

*Encoding:*

image::encodings/enc_hl_sdi_pr.svg[HL.SDI.PR encoding,width=800]
