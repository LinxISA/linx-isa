...
*Description:* HL.SHI.PR snapshots its scalar sources, forms its encoded address, and stores one aligned little-endian 2-byte value.

*Encoding:*

image::encodings/enc_hl_shi_pr.svg[HL.SHI.PR encoding,width=800]
