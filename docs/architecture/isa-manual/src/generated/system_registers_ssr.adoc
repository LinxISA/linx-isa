...
// Source: linxisa-v0.57.json (state.system_registers)
[[ssr-table]]
...
|`0xnf30` |`XBINFO_ACRn` |RW |Cross-block info register. Provides the CAC_TABLE base address for the selected ACR in the v0.57 profile.
