...
The v0.4 encoding model defines:
...
Within canonical `MPAR`/`MSEQ` shader-kernel bodies, v0.4 adds a unified `lx64` execution rule:
...
The authoritative encoding details live in `isa/v0.4/linxisa-v0.4.json`:
