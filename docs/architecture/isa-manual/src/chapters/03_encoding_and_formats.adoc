...
The v0.58 encoding model defines:
...
Within canonical `MPAR`/`MSEQ` shader-kernel bodies, v0.58 uses the unified `lx64` execution rule:
...
The authoritative encoding details live in `isa/v0.58/linxisa-v0.58.json`:
