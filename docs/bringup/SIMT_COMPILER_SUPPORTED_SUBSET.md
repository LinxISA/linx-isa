...
- plus an experimental bridge toward the newly frozen divergent `v0.57` SIMT
  contract.
...
This is implementation status, not the final intended `v0.57` SIMT contract.
...
- canonical `v0.57` parsing rejects `l.add ...` legacy syntax,
