...
Instructions in the **FSU** group of the LinxISA v0.58.6 catalog.
...
| [FCVTA](../instructions/fcvta.md) | `fcvta.{srcT2dstT} SrcL, ->{t, u, Rd}` | 32 | — | FCVTA converts an FP64, FP32, FP16, or E4M3 source to U64/U32/U16/U8 or S64/S32/S16/S8 with fixed round-away mode. |
| [FCVTM](../instructions/fcvtm.md) | `fcvtm.{srcT2dstT} SrcL, ->{t, u, Rd}` | 32 | — | FCVTM converts an FP64, FP32, FP16, or E4M3 source to U64/U32/U16/U8 or S64/S32/S16/S8 with fixed round-down mode. |
| [FCVTN](../instructions/fcvtn.md) | `fcvtn.{srcT2dstT} SrcL, ->{t, u, Rd}` | 32 | — | FCVTN converts an FP64, FP32, FP16, or E4M3 source to U64/U32/U16/U8 or S64/S32/S16/S8 with fixed round-nearest mode. |
| [FCVTP](../instructions/fcvtp.md) | `fcvtp.{srcT2dstT} SrcL, ->{t, u, Rd}` | 32 | — | FCVTP converts an FP64, FP32, FP16, or E4M3 source to U64/U32/U16/U8 or S64/S32/S16/S8 with fixed round-up mode. |
| [FCVTZ](../instructions/fcvtz.md) | `fcvtz.{srcT2dstT} SrcL, ->{t, u, Rd}` | 32 | — | FCVTZ converts an FP64, FP32, FP16, or E4M3 source to U64/U32/U16/U8 or S64/S32/S16/S8 with fixed round-toward-zero mode. |
...
| [SCVTF](../instructions/scvtf.md) | `scvtf.{srcT2dstT} SrcL, ->{t, u, Rd}` | 32 | — | SCVTF converts an S64, S32, S16, or S8 source to FP64, FP32, FP16, or E4M3 through the common scalar/TCVT profile. |
| [UCVTF](../instructions/ucvtf.md) | `ucvtf.{srcT2dstT} SrcL, ->{t, u, Rd}` | 32 | — | UCVTF converts a U64, U32, U16, or U8 source to FP64, FP32, FP16, or E4M3 through the common scalar/TCVT profile. |
