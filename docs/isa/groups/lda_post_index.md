...
Instructions in the **LDA/POST_INDEX** group of the LinxISA v0.58.5 catalog.

## Instructions

| Mnemonic | Assembly | Length | Decode | Description |
|----------|----------|--------|--------|-------------|
| [HL.LB.PO](../instructions/hl_lb_po.md) | `hl.lb.po [SrcL, SrcR<{.sw,.uw}><<<shamt>], ->Dst0, Dst1` | 48 | — | HL.LB.PO snapshots its scalar sources, forms its encoded address, and loads one aligned little-endian 1-byte value. |
...
| [HL.LBU.PO](../instructions/hl_lbu_po.md) | `hl.lbu.po [SrcL, SrcR<{.sw,.uw}><<<shamt>], ->Dst0, Dst1` | 48 | — | HL.LBU.PO snapshots its scalar sources, forms its encoded address, and loads one aligned little-endian 1-byte value. |
...
| [HL.LD.PO](../instructions/hl_ld_po.md) | `hl.ld.po [SrcL, SrcR<{.sw,.uw}><<<shamt>], ->Dst0, Dst1` | 48 | — | HL.LD.PO snapshots its scalar sources, forms its encoded address, and loads one aligned little-endian 8-byte value. |
...
| [HL.LH.PO](../instructions/hl_lh_po.md) | `hl.lh.po [SrcL, SrcR<{.sw,.uw}><<<shamt>], ->Dst0, Dst1` | 48 | — | HL.LH.PO snapshots its scalar sources, forms its encoded address, and loads one aligned little-endian 2-byte value. |
...
| [HL.LHU.PO](../instructions/hl_lhu_po.md) | `hl.lhu.po [SrcL, SrcR<{.sw,.uw}><<<shamt>], ->Dst0, Dst1` | 48 | — | HL.LHU.PO snapshots its scalar sources, forms its encoded address, and loads one aligned little-endian 2-byte value. |
...
| [HL.LW.PO](../instructions/hl_lw_po.md) | `hl.lw.po [SrcL, SrcR<{.sw,.uw}><<<shamt>], ->Dst0, Dst1` | 48 | — | HL.LW.PO snapshots its scalar sources, forms its encoded address, and loads one aligned little-endian 4-byte value. |
...
| [HL.LWU.PO](../instructions/hl_lwu_po.md) | `hl.lwu.po [SrcL, SrcR<{.sw,.uw}><<<shamt>], ->Dst0, Dst1` | 48 | — | HL.LWU.PO snapshots its scalar sources, forms its encoded address, and loads one aligned little-endian 4-byte value. |
