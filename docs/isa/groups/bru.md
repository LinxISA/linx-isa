...
Instructions in the **BRU** group of the LinxISA v0.58.5 catalog.
...
| [HL.ADDTPC](../instructions/hl_addtpc.md) | `hl.addtpc imm, ->{t, u, Rd}` | 48 | — | HL.ADDTPC - Add a signed 4 KiB page displacement to the current TPC. |
