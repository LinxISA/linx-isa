...
Alphabetical list of all 55 instruction groups in the LinxISA v0.58.5 catalog.
...
| [Bundle Split](bundle_split.md) | 52 | **Ch 4** — [source](index.md) | `BSTART`, `BSTART.FP`, `BSTART.GMOV`, `BSTART.MGATHER`, `BSTART.MGATHER.CAS`, `BSTART.MGATHER.MASK`, `BSTART.MPAR`, `BSTART.MSCATTER` +34 |
