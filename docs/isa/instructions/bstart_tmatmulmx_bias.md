...
<figure>
<img src="../wavedrom/enc_bstart_tmatmulmx_bias.svg" alt="BSTART.TMATMULMX.BIAS encoding" width="100%" />
...
- `Named CUBE-family Function=5. Micro-scaled matrix multiply with bias; requires B.DIM and CUBE tile bindings.`

## Full Catalog Forms

| Assembly | Length | Decode |
|----------|--------|--------|
| `BSTART.TMATMULMX.BIAS DataType` | 32 | — |
