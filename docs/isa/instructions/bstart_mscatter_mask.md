...
<figure>
<img src="../wavedrom/enc_bstart_mscatter_mask.svg" alt="BSTART.MSCATTER.MASK encoding" width="100%" />
...
- `Named TMA-family Function=7. Masked memory scatter; detailed PTO selector manifest is defined out-of-band for v0.57.`

## Full Catalog Forms

| Assembly | Length | Decode |
|----------|--------|--------|
| `BSTART.MSCATTER.MASK DataType` | 32 | — |
