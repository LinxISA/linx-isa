...
<figure>
<img src="../wavedrom/enc_casw.svg" alt="CASW encoding" width="100%" />
...
```c
// Execute CASW as defined by the Atomic Operation semantics.
```

## Encoding Notes

- `v0.58 32-bit compare-and-swap word: old=[SrcL]; if old==SrcR then [SrcL]=SrcD; RegDst=old. Supports aq/rl ordering and has no far flag.`

## Full Catalog Forms

| Assembly | Length | Decode |
|----------|--------|--------|
| `casw<.{aq, rl, aqrl}> [SrcL], SrcR, SrcD, ->{t, u, Rd}` | 32 | — |
