...
<figure>
<img src="../wavedrom/enc_bstart_tmatmulmx.svg" alt="BSTART.TMATMULMX encoding" width="100%" />
...
- `Named CUBE-family Function=4. Micro-scaled matrix multiply; requires B.DIM and CUBE tile bindings.`

## Full Catalog Forms

| Assembly | Length | Decode |
|----------|--------|--------|
| `BSTART.TMATMULMX DataType` | 32 | — |
