...
<figure>
<img src="../wavedrom/enc_bstart_mgather_xor.svg" alt="BSTART.MGATHER.XOR encoding" width="100%" />
...
- `Starts GM indexed mgather.xor operation.`

## Full Catalog Forms

| Assembly | Length | Decode |
|----------|--------|--------|
| `BSTART.MGATHER.XOR DataType` | 32 | — |
