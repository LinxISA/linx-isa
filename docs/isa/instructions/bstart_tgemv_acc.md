...
<figure>
<img src="../wavedrom/enc_bstart_tgemv_acc.svg" alt="BSTART.TGEMV.ACC encoding" width="100%" />
...
- `Named CUBE-family Function=18. Matrix-vector multiply-accumulate; requires B.DIM and CUBE tile bindings.`

## Full Catalog Forms

| Assembly | Length | Decode |
|----------|--------|--------|
| `BSTART.TGEMV.ACC DataType` | 32 | — |
