...
<figure>
<img src="../wavedrom/enc_bstart_tgemv.svg" alt="BSTART.TGEMV encoding" width="100%" />
...
- `Named CUBE-family Function=16. Matrix-vector multiply; requires B.DIM and CUBE tile bindings.`

## Full Catalog Forms

| Assembly | Length | Decode |
|----------|--------|--------|
| `BSTART.TGEMV DataType` | 32 | — |
