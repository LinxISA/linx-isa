...
<figure>
<img src="../wavedrom/enc_cmp_geui.svg" alt="CMP.GEUI encoding" width="100%" />
...
```c
// Execute CMP.GEUI as defined by the Compare Instruction semantics.
```
