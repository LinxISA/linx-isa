...
<figure>
<img src="../wavedrom/enc_casb.svg" alt="CASB encoding" width="100%" />
...
```c
// Execute CASB as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `casb<.{aq, rl, aqrl}> [SrcL], SrcR, SrcD, ->{t, u, Rd}` | 32 | — |
