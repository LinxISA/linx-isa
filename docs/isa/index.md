...
**ISA Version:** v0.58.6 &nbsp;·&nbsp; **773 instruction forms** &nbsp;·&nbsp; **55 groups** &nbsp;·&nbsp; **4 encoding formats**
...
[Bundle Range Modifier (2)](groups/bundle_range_modifier.md){.group-card} [Bundle Split (71)](groups/bundle_split.md){.group-card} [C.BSTART (7)](groups/c_bstart.md){.group-card} [Compare Instruction (16)](groups/compare_instruction.md){.group-card}
...
| [BSTART.MGATHER.ADD](instructions/bstart_mgather_add.md) | bundle_split | 32 | Terminates the current block and begins the next. |
...
[View all 773 instruction forms →](instructions/index.md)
